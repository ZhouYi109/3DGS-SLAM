...
public:
    Params(const YAML::Node &node)
    {
        ...
        detail_spawn_enabled = node["detail_spawn_enabled"] ? node["detail_spawn_enabled"].as<bool>() : false;
        detail_spawn_top_k = node["detail_spawn_top_k"] ? node["detail_spawn_top_k"].as<int>() : 512;
        detail_spawn_pixel_stride = node["detail_spawn_pixel_stride"] ? node["detail_spawn_pixel_stride"].as<int>() : 4;
        detail_spawn_sigma_small = node["detail_spawn_sigma_small"] ? node["detail_spawn_sigma_small"].as<double>() : 0.5;
        detail_spawn_sigma_large = node["detail_spawn_sigma_large"] ? node["detail_spawn_sigma_large"].as<double>() : 1.5;
        detail_spawn_threshold = node["detail_spawn_threshold"] ? node["detail_spawn_threshold"].as<double>() : 0.10;
        detail_spawn_alpha_power = node["detail_spawn_alpha_power"] ? node["detail_spawn_alpha_power"].as<double>() : 1.0;
        detail_spawn_detail_power = node["detail_spawn_detail_power"] ? node["detail_spawn_detail_power"].as<double>() : 1.0;
        detail_spawn_min_geometry_weight = node["detail_spawn_min_geometry_weight"] ? node["detail_spawn_min_geometry_weight"].as<double>() : 0.20;
        ...
        reliable_densification_detail_weight = node["reliable_densification_detail_weight"] ? node["reliable_densification_detail_weight"].as<double>() : 0.0;
        reliable_densification_detail_floor = node["reliable_densification_detail_floor"] ? node["reliable_densification_detail_floor"].as<double>() : 0.05;
    ...
    double detail_spawn_sigma_small;
    double detail_spawn_sigma_large;
    double detail_spawn_threshold;
    double detail_spawn_alpha_power;
    double detail_spawn_detail_power;
    double detail_spawn_min_geometry_weight;
    ...
    double reliable_densification_detail_weight;
    double reliable_densification_detail_floor;
