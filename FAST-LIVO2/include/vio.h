...
public:
  ...
  double visual_factor_weight_ = 1.0;
  double semantic_visual_weight_sum_ = 0.0;
  size_t semantic_visual_weight_count_ = 0;
  ...
  void setVisualFactorWeight(double weight) { visual_factor_weight_ = std::max(0.05, std::min(1.0, weight)); }
  void setVisualSemanticRiskMap(const cv::Mat &risk_map) { semantic_risk_visual_map_ = risk_map.clone(); }
